...
// ! Sepete ekle butonuna tıkladığımda litle-box divinin değerini artırmak için ;
const row = document.querySelector(".row");
...
const sepeteEkle = (parentDiv) => {
   ...
   ürünBilgisi.innerHTML += `
    ...
    <div class="fotograf">
        <img width="200px" height="150px" id="ürün-img" src="${image}">
    </div>
